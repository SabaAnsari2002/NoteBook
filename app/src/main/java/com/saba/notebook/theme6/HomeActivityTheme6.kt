...
class HomeActivityTheme6 : AppCompatActivity() {
    ...
    private fun openNoteDetails(position: Int) {
        ...
        val intent = Intent(this, AddNoteActivityTheme6::class.java)
        ...
        btnLogout.setOnClickListener {
            ...
            AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes") { _, _ ->
                    ...
                    startActivity(Intent(this, MainActivityTheme6::class.java))
                    finish()
                }
