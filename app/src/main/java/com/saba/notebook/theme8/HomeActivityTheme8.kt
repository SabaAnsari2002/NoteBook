...
class HomeActivityTheme8 : AppCompatActivity() {
    ...
    private fun openNoteDetails(position: Int) {
        ...
        val intent = Intent(this, AddNoteActivityTheme8::class.java)
        ...
        btnLogout.setOnClickListener {
            ...
            AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes") { _, _ ->
                    ...
                    startActivity(Intent(this, MainActivityTheme8::class.java))
                    finish()
                }
